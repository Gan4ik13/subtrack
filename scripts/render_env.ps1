...
$want = @("YOOMONEY_WALLET", "YOOMONEY_TOKEN", "YOOMONEY_NOTIFY_SECRET", "TG_BOT_TOKEN", "DATABASE_URL", "OWNER_TG_CHAT_ID", "OWNER_EMAIL", "YOOKASSA_SHOP_ID", "YOOKASSA_SECRET_KEY")
$toSet = @{}
